...
| Skill | In practice |
| :-- | :-- |
| Data management | Data strategy, governance frameworks and retention policy for Defence and utility clients. |
...
| **Data engineering** | modelling, pipelines, notebook-based delivery |
| **AI** | Agentic AI systems, LLM workflows, practical automation |
| **Governance** | access controls, delivery assurance |
| **Enterprise systems** | Oracle, SAP, Maximo, Salesforce, P6 Primavera, RIBCX ( iTWOcx) integration contexts |
